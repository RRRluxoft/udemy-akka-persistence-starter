...
class UserRegistrationSerializer extends Serializer {
  ...
  override def identifier: Int = 53278 // any number you do
  ...
  override def fromBinary(bytes: Array[Byte], manifest: Option[Class[_]]): AnyRef = {
    ...
    val values: Array[String] = string.substring(1, string.length - 1).split(SEPARATOR)
...
//  for (i <- 1 to 10) {
//    userRegistrationActor ! RegisterUser(s"user_$i@rtjvm.com", s"User_$i")
//  }
